...
public final class class_005fuserInfoEdit_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 String class_no =
	...
	String[] classList = {"AT11A192", "AT11B203", "CG11A172", "IT11A172", "AT12A165",
	 ...
	 "CD13A166", "AP14A226", "AT14A226", "IH14A223", "CT14A187", "IW14A187", "xx14Axx"};
      ...
      out.write("    >\r\n");
      out.write("      <div class=\"card shadow-lg p-8 bg-white w-1/4\">\r\n");
      out.write("\t\t\t\t<div class=\"pb-2 text-xl font-bold text-gray-700 text-center\">\r\n");
      out.write("\t\t\t\t\tクラス名簿 - 更新\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td class='w-24 pb-2'>クラス記号</td> \r\n");
      out.write("\t\t\t\t\t\t\t\t<td class=\"pb-2\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<select\r\n");
 ...
 if(classList[i].equals(class_no)) { 
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td class=\"pb-2\">出席番号</td> \r\n");
      out.write("\t\t\t\t\t\t\t\t<td class=\"pb-2\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\ttype=\"text\"\r\n");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td class=\"pb-2\">学籍番号</td> \r\n");
      out.write("\t\t\t\t\t\t\t\t<td class=\"pb-2\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\ttype=\"text\"\r\n");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td class=\"pb-2\">氏名(姓)</td> \r\n");
      out.write("\t\t\t\t\t\t\t\t<td class=\"pb-2\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\ttype=\"text\"\r\n");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td class=\"pb-2\">氏名(名)</td> \r\n");
      out.write("\t\t\t\t\t\t\t\t<td class=\"pb-2\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\ttype=\"text\"\r\n");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td class=\"pb-2\">カナ(姓)</td> \r\n");
      out.write("\t\t\t\t\t\t\t\t<td class=\"pb-2\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\ttype=\"text\"\r\n");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td class=\"pb-2\">カナ(名)</td> \r\n");
      out.write("\t\t\t\t\t\t\t\t<td class=\"pb-2\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\ttype=\"text\"\r\n");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td class=\"pb-4\">生年月日</td> \r\n");
      out.write("\t\t\t\t\t\t\t\t<td class=\"pb-4\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\ttype=\"text\"\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<th colspan=\"2\" class=\"pb-2\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<button class=\"btn btn-primary btn-wide w-full\">更新</button>\r\n");
      out.write("\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t</form>\r\n");
      out.write("\r\n");
      ...
      out.write("\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<button class=\"btn btn-secondary btn-wide  w-full\">削除</button>\r\n");
      out.write("\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t</form>\r\n");
      out.write("\t\t\t\t\t</tbody>\r\n");
 ...
 if(classList[i].equals(class_no)) { 
      ...
      out.write("\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<button class=\"btn btn-secondary btn-wide  w-full\">削除 - OP1</button>\r\n");
      out.write("\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t</form>\r\n");
      out.write("\t\t\t\t\t</tbody>\r\n");

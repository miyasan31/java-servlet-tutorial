...
public final class sd_005fallNames_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
 	...
 	try{
      ...
      out.write(" <body>\r\n");
      out.write("\r\n");
      out.write(" <form method=\"post\" action=\"./servlet/sd_intime\">\r\n");
      out.write("\t<select name=\"EMPLOYEE_ID\">\r\n");
      out.write("\t\t\t<option disabled selected>選択してください</option>\r\n");
      out.write("\t\t\t");
 for (int i = 0; i < list.size(); i++) { 
      out.write("\r\n");
      out.write("\t\t\t\t\t<option value=\"");
      out.print( list.get(i).get("f_employee_id") );
      out.write("\">\r\n");
      out.write("\t\t\t\t\t\t");

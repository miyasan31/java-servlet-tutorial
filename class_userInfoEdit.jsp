...
<html>
  ...
  <body>
    ...
    >
      <div class="card shadow-lg p-8 bg-white w-1/3">
              ...
              クラス名簿 - 更新
				...
				<table class="table w-full">
					<tbody>
						...
						<tr>
							<th colspan="2">
								<button class="btn btn-primary btn-wide w-44">更新</button>
        				</form>
							</th>
						</tr>
						<tr>	
							<th colspan="2">
								<form action="./class_update_deleteSort1" method="POST">
									...
									<input
										...
										value="<%= gakuseki_no %>"
										/>
									<button class="btn btn-secondary btn-wide w-44">削除 - OP1</button>
								</form>
							</th>
						</tr>
					</tbody>

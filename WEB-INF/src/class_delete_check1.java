...
public class class_delete_check1 extends HttpServlet {
    ...
    sb.append("<html>");
      ...
      sb.append("<body>");
        sb.append("<div class='h-screen w-full'>");
					...
					sb.append("<form action='./class_delete_done1' method='POST'>");
						sb.append("<div class='px-5 w-2/3 mx-auto'>");

							sb.append("<div class='text-secondary text-lg py-3 bg-white'>こちらのユーザーを削除してもよろしいですか？</div>");
							...
							sb.append("<table class='table table-compact w-full rounded-lg'>");
								...
								sb.append("<div class='flex justify-center pt-5'>");
									sb.append("<button class='btn btn-primary btn-wide mt-5'>削除</button>");
								sb.append("</div>");

							sb.append("<div class='flex justify-center pt-5'>");
								sb.append("<a href='/JV27/class_delete.html'><button type='button' class='btn btn-link'>検索に戻る</button></a>");

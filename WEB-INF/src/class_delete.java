		...
		sb.append("<html>");
			...
			sb.append("<body>");
				sb.append("<div class='h-screen w-full'>");
					...
					sb.append("<form action='./class_delete_check' method='POST'>");
									...
									while (rs.next()) {
										...
										sb.append("<tbody>");
											sb.append("<tr>");
												sb.append("<td>");
													sb.append("<label>");
														sb.append("<input class='radio radio-primary radio-mark' type='radio' name='DELETE_ID' value='" + gakuseki_no + "' />");
														sb.append("<span class='radio-mark'></span>");
													sb.append("<label>");
												sb.append("</td>");
												sb.append("<td>");

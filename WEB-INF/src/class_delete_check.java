...
public class class_delete_check extends HttpServlet {
    ...
    sb.append("<html>");
      ...
      sb.append("<body>");
        sb.append("<div class='h-screen w-full'>");
					...
					sb.append("<form action='./class_delete_done' method='POST'>");
						sb.append("<div class='px-5 w-2/3 mx-auto'>");
							...
							sb.append("<div class='flex justify-center pt-5'>");
								sb.append("<button class='btn btn-primary btn-wide'>削除</button>");
							sb.append("</div>");

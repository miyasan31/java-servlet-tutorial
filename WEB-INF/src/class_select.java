...
public class class_select extends HttpServlet {
	...
	public void doPost (
		...
		String searchStr = "";
		String selectStr = req.getParameter("SELECT");
		if (selectStr.equals("1")) {
			searchStr = req.getParameter("GAKUNEN_NO");
		} else if (selectStr.equals("2")) {
			searchStr = req.getParameter("CLASS_NO");
		} 
				...
				sb.append("<div class='h-screen w-full'>");
					...
					try {
						...
						if (selectStr.equals("1")) {
							...
							query.append("class_no like '");
							query.append("___" + searchStr + "____");
